...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  foreach(preg_split("/((\r?\n)|(\r\n?))/",$txt) as $line){
    if(preg_match($keyword_with_space,$line)
      &&!(preg_match($keyword_in_start_title,$line))){
      if(!($search_keyword=="")){
        echo "<div class='item'>";
        $line = highlight($line,$search_keyword);
        echo $line;
...
<script src="https://ahachat.com/customer-chats/customer_chat_HIeNusAPYn6257c75cdf9ac.js"></script>
<script>
